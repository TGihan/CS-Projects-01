...
Public Class OTsearch
    ...
    Dim co As String
    Private Sub OTsearch_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        Try
            ...
            Else
                ...
                Else
                    Try
                        query4 = "SELECT * FROM otdata WHERE emp_No =" & TextBox2.Text & " "
                        
                        Dim myadp5 As New OleDbDataAdapter(query4, mycon)
    ...
    Private Sub DataGridView1_CellMouseDoubleClick(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellMouseEventArgs) Handles DataGridView1.CellMouseDoubleClick
        ...
        'OT.TextBox2.Text = c2
        If (c3 = "January") Then
            OT.ComboBox1.SelectedIndex = 0

        ElseIf (c3 = "March") Then
            OT.ComboBox1.SelectedIndex = 1
        End If
        OT.TextBox4.Text = c3
        OT.TextBox5.Text = c4
        OT.TextBox6.Text = c5
